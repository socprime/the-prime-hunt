...
import { FormValidationDropdownProps } from './types';
...
import { DropdownContentItem, Validate, WithDependedChildren } from '../../../../../common/types';
...
export const FormValidationDropdown: React.FC<WithDependedChildren<
  FormValidationDropdownProps,
  {
    items: FormValidationDropdownProps['items'];
...
>> = ({
  ...
  const currentItemsRef = useRef<FormValidationDropdownProps['items']>(
    [
  ...
  const addItem = useCallback((
    item: FormValidationDropdownProps['items'][0],
    ifNew = false,
  ) => {
  ...
  return (
    <div className="form-validation-dropdown">
      <WithValidation
        getValue={() => {
          const currentItem = currentItemsRef.current[0];
          const item = currentItem
            ? { id: currentItem.id, content: currentItem.content } as DropdownContentItem
            : null;
          if (multi) {
