...
export const microsoftSentinelPagesInline = 'inline-microsoft-sentinel-pages.js';
...
export const accessibleResources: {
  ...
  [PlatformID.MicrosoftSentinel]: [microsoftSentinelInline, microsoftSentinelPagesInline],
