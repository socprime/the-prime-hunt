...
describe('Elastic App tests', () => {
  const platformID = PlatformID.Elastic;
  ...
  test('should provide copy actions', async () => {
    ...
    expect(mockedCopyToClipboard.mock.calls[1][0]).toEqual('AND test0:("account1" OR 2 OR "test2" OR 4 OR "test\\domain.com" OR "\\"process.exe\\" -a -g https://some.site/some-page")');
  });
