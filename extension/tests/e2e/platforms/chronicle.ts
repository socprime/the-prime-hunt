...
suiteGlobals.messages = {
  ...
  test2IncludeBulkAction: '(TestTable) AND (test0 = "account1" OR test0 = "2" OR test0 = "test\\\\domain.com" OR test0 = "4" OR test0 = "\\"process.exe\\" -a -g https://some.site/some-page") AND (test2 = "account2" OR test2 = "2" OR test2 = "4")',
  ...
  test2ShowAllBulkAction: '(test0 = "account1" OR test0 = "2" OR test0 = "test\\\\domain.com" OR test0 = "4" OR test0 = "\\"process.exe\\" -a -g https://some.site/some-page") AND (test2 = "account2" OR test2 = "2" OR test2 = "4")',
};
