...
(() => {
/*!**************************************************!*\
  !*** ./extension/inline/splunk/inline-splunk.ts ***!
  \**************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _common_common_listeners__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../common/common-listeners */ "./extension/common/common-listeners.ts");
...
/* harmony import */ var _content_platforms_SplunkPlatform__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../content/platforms/SplunkPlatform */ "./extension/content/platforms/SplunkPlatform.ts");
...
const platform = new _content_platforms_SplunkPlatform__WEBPACK_IMPORTED_MODULE_3__.SplunkPlatform();
const loggers = (__webpack_require__(/*! ../../common/loggers */ "./extension/common/loggers/index.ts").loggers)
    .addPrefix(platform.getID());
const getEditor = () => {
    return (0,_helpers_ace_editor_helpers__WEBPACK_IMPORTED_MODULE_2__.getEditor)(document.querySelector('pre.ace_editor'));
};
window.addEventListener('message', (event) => {
    ...
    if ((0,_common_common_listeners__WEBPACK_IMPORTED_MODULE_0__.isMessageMatched)(() => _types_types_inline_messages__WEBPACK_IMPORTED_MODULE_1__.MessageToInline.ISModifyQuery === message.type, message, event)) {
        ...
        editor.setValue((0,_helpers_ace_editor_helpers__WEBPACK_IMPORTED_MODULE_2__.buildNewQuery)(editor.getValue(), suffix, modifyType));
    }
