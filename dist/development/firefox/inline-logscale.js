...
(() => {
/*!******************************************************!*\
  !*** ./extension/inline/logscale/inline-logscale.ts ***!
  \******************************************************/
__webpack_require__.r(__webpack_exports__);
...
/* harmony import */ var _content_platforms_LogScalePlatform__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../content/platforms/LogScalePlatform */ "./extension/content/platforms/LogScalePlatform.ts");
...
const platform = new _content_platforms_LogScalePlatform__WEBPACK_IMPORTED_MODULE_3__.LogScalePlatform();
const loggers = (__webpack_require__(/*! ../../common/loggers */ "./extension/common/loggers/index.ts").loggers)
    .addPrefix(platform.getID());
const getEditor = () => {
    const editor = document.querySelector('#query-input')?.editor?.model;
    if (!editor) {
...
window.addEventListener('message', (event) => {
    ...
    if ((0,_common_common_listeners__WEBPACK_IMPORTED_MODULE_1__.isMessageMatched)(() => _types_types_inline_messages__WEBPACK_IMPORTED_MODULE_0__.MessageToInline.ISModifyQuery === message.type, message, event)) {
        ...
        editor.setValue((0,_helpers_monaco_editor_helpers__WEBPACK_IMPORTED_MODULE_2__.buildNewQuery)(editor, suffix, modifyType, false));
    }
