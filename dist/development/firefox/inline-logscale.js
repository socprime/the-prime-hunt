...
const LogScalePlatform_1 = __webpack_require__(/*! ../../content/platforms/LogScalePlatform */ "./extension/content/platforms/LogScalePlatform.ts");
...
const helpers_1 = __webpack_require__(/*! ../../../common/helpers */ "./common/helpers.ts");
const platform = new LogScalePlatform_1.LogScalePlatform();
const loggers = (__webpack_require__(/*! ../../common/loggers */ "./extension/common/loggers/index.ts").loggers.addPrefix)(platform.getID());
const getEditor = () => {
    var _a, _b;
    const editor = (_b = (_a = document.querySelector('#query-input')) === null || _a === void 0 ? void 0 : _a.editor) === null || _b === void 0 ? void 0 : _b.model;
    if (!editor) {
...
window.addEventListener('message', (event) => {
    ...
    if ((0, common_listeners_1.isMessageMatched)(() => types_inline_messages_1.MessageToInline.ISModifyQuery === message.type, message, event)) {
        ...
        editor.setValue((0, monaco_editor_helpers_1.buildNewQuery)(editor, suffix, modifyType, false));
    }
