...
const AmazonAthenaPlatform_1 = __webpack_require__(/*! ../../content/platforms/AmazonAthenaPlatform */ "./extension/content/platforms/AmazonAthenaPlatform.ts");
const common_helpers_1 = __webpack_require__(/*! ../../common/common-helpers */ "./extension/common/common-helpers.ts");
const types_app_messages_1 = __webpack_require__(/*! ../../app/types/types-app-messages */ "./extension/app/types/types-app-messages.ts");
const platform = new AmazonAthenaPlatform_1.AmazonAthenaPlatform();
...
window.addEventListener('message', (event) => {
    ...
    if ((0, common_listeners_1.isMessageMatched)(() => types_inline_messages_1.MessageToInline.ISRemoveHash === message.type, message, event)) {
        const editor = getEditor();
        if (!editor) {
            return;
        }
...
if (aceContent) {
    ...
    (0, common_helpers_1.waitHTMLElement)('.ace_content', document.querySelector('body'))
