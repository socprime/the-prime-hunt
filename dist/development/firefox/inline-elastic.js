...
(() => {
/*!****************************************************!*\
  !*** ./extension/inline/elastic/inline-elastic.ts ***!
  \****************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _common_common_listeners__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../common/common-listeners */ "./extension/common/common-listeners.ts");
...
/* harmony import */ var _content_platforms_ElasticPlatform__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../content/platforms/ElasticPlatform */ "./extension/content/platforms/ElasticPlatform.ts");
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../helpers */ "./extension/inline/helpers/index.ts");
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./helpers */ "./extension/inline/elastic/helpers.ts");





const platform = new _content_platforms_ElasticPlatform__WEBPACK_IMPORTED_MODULE_2__.ElasticPlatform();
...
window.addEventListener('message', (event) => {
    ...
    if ((0,_common_common_listeners__WEBPACK_IMPORTED_MODULE_0__.isMessageMatched)(() => _types_types_inline_messages__WEBPACK_IMPORTED_MODULE_1__.MessageToInline.ISModifyQuery === message.type, message, event)) {
        const input = (0,_helpers__WEBPACK_IMPORTED_MODULE_4__.getInput)();
        if (!input) {
    ...
    if ((0,_common_common_listeners__WEBPACK_IMPORTED_MODULE_0__.isMessageMatched)(() => _types_types_inline_messages__WEBPACK_IMPORTED_MODULE_1__.MessageToInline.ISGetQuery === message.type, message, event)) {
        ...
        (0,_helpers__WEBPACK_IMPORTED_MODULE_3__.sendQueryToApp)(input.value);
    }
});
