...
const ChroniclePlatform_1 = __webpack_require__(/*! ../../content/platforms/ChroniclePlatform */ "./extension/content/platforms/ChroniclePlatform.ts");
...
const helpers_1 = __webpack_require__(/*! ../../../common/helpers */ "./common/helpers.ts");
const platform = new ChroniclePlatform_1.ChroniclePlatform();
const loggers = (__webpack_require__(/*! ../../common/loggers */ "./extension/common/loggers/index.ts").loggers.addPrefix)(platform.getID());
const getEditor = () => {
    var _a;
    if (typeof ((_a = monaco === null || monaco === void 0 ? void 0 : monaco.editor) === null || _a === void 0 ? void 0 : _a.getModels) === 'undefined') {
...
window.addEventListener('message', (event) => {
    ...
    if ((0, common_listeners_1.isMessageMatched)(() => types_inline_messages_1.MessageToInline.ISModifyQuery === message.type, message, event)) {
        ...
        const newValue = (0, monaco_editor_helpers_1.buildNewQuery)(editor, suffix, modifyType)
            .replace('<unknown> AND ', '');
        if (modifyType !== 'show all') {
            ...
            editor.setValue((0, helpers_1.clearExtraSpaces)(newValue.replace(prefix, `${newPrefix} `)));
            return;
        }
        editor.setValue((0, helpers_1.clearExtraSpaces)(`( ${suffix}`));
    }
