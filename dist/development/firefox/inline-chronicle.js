...
(() => {
/*!********************************************************!*\
  !*** ./extension/inline/chronicle/inline-chronicle.ts ***!
  \********************************************************/
__webpack_require__.r(__webpack_exports__);
...
/* harmony import */ var _content_platforms_ChroniclePlatform__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../content/platforms/ChroniclePlatform */ "./extension/content/platforms/ChroniclePlatform.ts");
...
const platform = new _content_platforms_ChroniclePlatform__WEBPACK_IMPORTED_MODULE_3__.ChroniclePlatform();
...
window.addEventListener('message', (event) => {
    ...
    if ((0,_common_common_listeners__WEBPACK_IMPORTED_MODULE_1__.isMessageMatched)(() => _types_types_inline_messages__WEBPACK_IMPORTED_MODULE_0__.MessageToInline.ISModifyQuery === message.type, message, event)) {
        ...
        const newValue = (0,_helpers_monaco_editor_helpers__WEBPACK_IMPORTED_MODULE_2__.buildNewQuery)(editor, suffix, modifyType)
            .replace('<unknown> AND ', '');
        if (modifyType !== 'show all') {
            ...
            editor.setValue(normalizeValue((0,_common_helpers__WEBPACK_IMPORTED_MODULE_4__.clearExtraSpaces)(newValue.replace(prefix, `${newPrefix} `))));
            return;
        }
        editor.setValue(normalizeValue((0,_common_helpers__WEBPACK_IMPORTED_MODULE_4__.clearExtraSpaces)(`(${suffix}`)));
    }
