...
const serviceLoggers = (__webpack_require__(/*! ../../common/loggers */ "./extension/common/loggers/index.ts").loggers)
    .addPrefix('services');
...
(() => {
/*!****************************************************************!*\
  !*** ./extension/inline/amazon-athena/inline-amazon-athena.ts ***!
  \****************************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _common_common_listeners__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../common/common-listeners */ "./extension/common/common-listeners.ts");
/* harmony import */ var _types_types_inline_messages__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../types/types-inline-messages */ "./extension/inline/types/types-inline-messages.ts");
/* harmony import */ var _helpers_ace_editor_helpers__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../helpers/ace-editor-helpers */ "./extension/inline/helpers/ace-editor-helpers.ts");
/* harmony import */ var _helpers_aql_builder__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../helpers/aql-builder */ "./extension/inline/helpers/aql-builder.ts");
/* harmony import */ var _common_helpers__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../common/helpers */ "./common/helpers.ts");
/* harmony import */ var _content_types_types_content_messages__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../content/types/types-content-messages */ "./extension/content/types/types-content-messages.ts");
/* harmony import */ var _content_platforms_AmazonAthenaPlatform__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../content/platforms/AmazonAthenaPlatform */ "./extension/content/platforms/AmazonAthenaPlatform.ts");
/* harmony import */ var _common_common_helpers__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../common/common-helpers */ "./extension/common/common-helpers.ts");
/* harmony import */ var _app_types_types_app_messages__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../app/types/types-app-messages */ "./extension/app/types/types-app-messages.ts");
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../helpers */ "./extension/inline/helpers/index.ts");
...
const platform = new _content_platforms_AmazonAthenaPlatform__WEBPACK_IMPORTED_MODULE_6__.AmazonAthenaPlatform();
const loggers = (__webpack_require__(/*! ../../common/loggers */ "./extension/common/loggers/index.ts").loggers)
    .addPrefix(platform.getID());
const getEditor = () => {
    return (0,_helpers_ace_editor_helpers__WEBPACK_IMPORTED_MODULE_2__.getEditor)(document.querySelector('.ace_editor'));
};
...
window.addEventListener('message', (event) => {
    const message = event.data;
    if ((0,_common_common_listeners__WEBPACK_IMPORTED_MODULE_0__.isMessageMatched)(() => _types_types_inline_messages__WEBPACK_IMPORTED_MODULE_1__.MessageToInline.ISModifyQuery === message.type, message, event)) {
        ...
        let parsedQuery = (0,_helpers_aql_builder__WEBPACK_IMPORTED_MODULE_3__.parseQueryString)(editor.getValue());
        ...
        parsedQuery.where = (0,_helpers_aql_builder__WEBPACK_IMPORTED_MODULE_3__.addWhere)(parsedQuery.where || '', platform.buildQueryParts(modifyType, resources), 'AND');
        editor.setValue((0,_helpers_aql_builder__WEBPACK_IMPORTED_MODULE_3__.buildNewQuery)(parsedQuery));
    }
    if ((0,_common_common_listeners__WEBPACK_IMPORTED_MODULE_0__.isMessageMatched)(() => _types_types_inline_messages__WEBPACK_IMPORTED_MODULE_1__.MessageToInline.ISSetQuery === message.type, message, event)) {
        const editor = getEditor();
        if (!editor) {
            return;
        }
    ...
    if ((0,_common_common_listeners__WEBPACK_IMPORTED_MODULE_0__.isMessageMatched)(() => _types_types_inline_messages__WEBPACK_IMPORTED_MODULE_1__.MessageToInline.ISGetQuery === message.type, message, event)) {
        const editor = getEditor();
        if (!editor) {
            return;
        }
        (0,_helpers__WEBPACK_IMPORTED_MODULE_9__.sendQueryToApp)(editor.getValue());
    }
    if ((0,_common_common_listeners__WEBPACK_IMPORTED_MODULE_0__.isMessageMatched)(() => _types_types_inline_messages__WEBPACK_IMPORTED_MODULE_1__.MessageToInline.ISSetDebugMode === message.type, message, event)) {
        const { debugMode } = message.payload;
        (__webpack_require__(/*! ../../common/loggers */ "./extension/common/loggers/index.ts").setDebugMode)(debugMode);
    }
    if ((0,_common_common_listeners__WEBPACK_IMPORTED_MODULE_0__.isMessageMatched)(() => _types_types_inline_messages__WEBPACK_IMPORTED_MODULE_1__.MessageToInline.ISRemoveHash === message.type, message, event)) {
        const editor = getEditor();
        if (!editor) {
            return;
        }
    ...
    if ((0,_common_common_listeners__WEBPACK_IMPORTED_MODULE_0__.isMessageMatched)(() => _types_types_inline_messages__WEBPACK_IMPORTED_MODULE_1__.MessageToInline.ISRemoveFieldSpecification === message.type, message, event)) {
        const editor = getEditor();
        if (!editor) {
            return;
        }
...
const checkFieldSpecification = () => {
    ...
    window.postMessage({
        id: (0,_common_helpers__WEBPACK_IMPORTED_MODULE_4__.uuid)(),
        type: _content_types_types_content_messages__WEBPACK_IMPORTED_MODULE_5__.MessageToContent.CSDirectMessageToApp,
        payload: {
            type: _app_types_types_app_messages__WEBPACK_IMPORTED_MODULE_8__.MessageToApp.AppQueryHasSpecifyFields,
            payload: {
                show: isShow,
            },
        },
...
if (aceContent) {
    ...
    (0,_common_common_helpers__WEBPACK_IMPORTED_MODULE_7__.waitHTMLElement)('.ace_content', document.querySelector('body'))
